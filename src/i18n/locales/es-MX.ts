export const esMX = {
  ...
  goals: {
    ...
    goalDescs: {
      fall_faster: 'Técnicas para dormir en menos de 20 minutos',
  ...
  profile: {
    ...
    resetConfirmMsg: 'Todos tus datos serán eliminados. Esta acción no se puede deshacer.',
