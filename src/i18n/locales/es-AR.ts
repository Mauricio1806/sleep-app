export const esAR = {
  welcome: {
    title: 'Dormí mejor,\nviví mejor.',
    subtitle: 'Tu plan de sueño personalizado con tu coach, hecho para vos.',
    cta: 'Empezar ahora',
  ...
  memory: {
    ...
    intentionPlaceholder: '¿Qué querés recordar mañana?',
    ...
    tips: [
      ...
      'El sueño REM consolida memorias emocionales — dormí bien después de días importantes',
